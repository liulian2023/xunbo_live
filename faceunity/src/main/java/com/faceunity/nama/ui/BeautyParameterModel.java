...
public final class BeautyParameterModel {
     ...
     * 默认滤镜 自然 1
     */
    public static Filter sFilter = FilterEnum.ziran_1.create();
    // 美型默认参数
    private static final Map<Integer, Float> FACE_SHAPE_DEFAULT_PARAMS = new HashMap<>(16);

    private static float sColorLevel = 0.0f;// 美白
    private static float sBlurLevel = 0.0f; // 精细磨皮程度
    ...
    private static float sCheekV = 0.0f;//V脸
    private static float sCheekNarrow = 0f;//窄脸
    private static float sCheekSmall = 0f;//小脸
    private static float sEyeEnlarging = 0.0f;//大眼
