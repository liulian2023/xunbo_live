...
import com.zz.live.bean.MotionData;
import com.zz.live.myView.TCHorizontalScrollView;
...
public class BeautyPanel extends FrameLayout implements SeekBar.OnSeekBarChangeListener, View.OnClickListener {
    ...
    private void initView() {
        mTextColorPrimary = UIAttributeUtil.getColorRes(mContext, R.attr.beautyPanelColorPrimary, R.color.red);
