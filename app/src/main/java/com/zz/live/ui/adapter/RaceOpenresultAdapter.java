...
//        holder.time.setText(DateUtil.stampToCountDown(String.valueOf(bean.getLotterytime())));
        ...
        if (bean.getMarkdx().equals("大")){
            holder.race_hezhi_two.setTextColor(context.getResources().getColor(R.color.racepink));
        }else {
            holder.race_hezhi_two.setTextColor(context.getResources().getColor(R.color.raceblue));
        }
        if (bean.getMarkds().equals("双")){
            holder.race_hezhi_three.setTextColor(context.getResources().getColor(R.color.racepink));
        }else {
            holder.race_hezhi_three.setTextColor(context.getResources().getColor(R.color.raceblue));
        }
