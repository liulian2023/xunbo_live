...
public class MarksixOpenresultAdapter extends RecyclerView.Adapter<MarksixOpenresultAdapter.VH>{
    ...
    public void onBindViewHolder(@NonNull VH holder, int position) {
       ...
       /* kjList.clear();
        ...
        holder.marksix_openresult_no_tv1.setBackground(context.getResources().getDrawable(bkgcolor_list.get(0)));
        holder.marksix_openresult_no_tv2.setText(list.get(1));
        holder.marksix_openresult_no_tv2.setBackground(context.getResources().getDrawable(bkgcolor_list.get(1)));
        holder.marksix_openresult_no_tv3.setText(list.get(2));
        holder.marksix_openresult_no_tv3.setBackground(context.getResources().getDrawable(bkgcolor_list.get(2)));
        holder.marksix_openresult_no_tv4.setText(list.get(3));
        holder.marksix_openresult_no_tv4.setBackground(context.getResources().getDrawable(bkgcolor_list.get(3)));
        holder.marksix_openresult_no_tv5.setText(list.get(4));
        holder.marksix_openresult_no_tv5.setBackground(context.getResources().getDrawable(bkgcolor_list.get(4)));
        holder.marksix_openresult_no_tv6.setText(list.get(5));
        holder.marksix_openresult_no_tv6.setBackground(context.getResources().getDrawable(bkgcolor_list.get(5)));
        holder.marksix_openresult_no_tv7.setText(list.get(6));
        holder.marksix_openresult_no_tv7.setBackground(context.getResources().getDrawable(bkgcolor_list.get(6)));
